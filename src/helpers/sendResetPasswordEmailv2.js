...
const templateSource = fs.readFileSync(
  path.join(__dirname, "../static/sendResetPasswordEmailTemplate.hbs"),
  "utf-8"
);
...
async function sendResetPasswordEmailV2(email, OTP) {
  ...
  let mailOptions = {
    from: `"Markethackai" <${config.mailFromAddress}>`,
    to: email,
    subject: "Welcome to Markethack.ai - Reset Password OTP",
